...
describe Source do
  it 'is valid if at least one argument is given' do
    expect(Source.create media: Forgery::LoremIpsum.words).to be_valid
    expect(Source.create title: Forgery::LoremIpsum.words).to be_valid
    expect(Source.create url: Forgery::LoremIpsum.words).to be_valid
  end
